...
\end{tightemize}
\hfill \location{Ruby, Mysql, EmberJS | May 2017 – Aug 2017 | Toronto, ON}
\begin{tightemize}
...
\runsubsection{AnySoftKeyboard (Open Source Contributor)} \hfill
...
\runsubsection{GlideN64 (Open Source Contributor)} \hfill
\location{C++, OpenGL}
\begin{tightemize}
...
\runsubsection{DIY Head Tracking Cardboard VR Space Shooter } \hfill
