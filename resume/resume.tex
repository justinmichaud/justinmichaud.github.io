...
\begin{tightemize}
	...
	\item Optimized queries, indexes, denormalized columns and UX to support accounts with hundreds of thousands of incidents
\end{tightemize}
\sectionsep
...
\begin{tightemize}
	...
	\item Allows importing/exporting Super Mario Bros levels, used in machine learning project (see blog)
